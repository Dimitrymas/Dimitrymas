...
Backend-focused fullstack developer. I build with Python + TypeScript, ship with Docker and CI/CD, and maintain full control over infrastructure — from logic to deployment.
